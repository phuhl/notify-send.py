...
def _action_callback(nid, action, maybe_data=None):
    ...
    try:
        ...
        return
    n._action_callback(action, maybe_data)
...
class Notification(object):
    ...
    def _action_callback(self, action, maybe_data):
        ...
        callback(self, action, maybe_data)
